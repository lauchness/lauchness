...
Ok, so I went over to the Emotion slack (they’re really responsive and nice over there, definitely [sign up if you’re interested in being part of the Emotion community](https://emotion-slack.now.sh/)), and spoke to [andarist](https://github.com/andarist) to wrap my head around this as best I could, and here’s what I put together.
...
Emotion has two ways styles are generated:
